...
//  private final String ACTION_USB_PERMISSION = BuildConfig.LIBRARY_PACKAGE_NAME + ".GRANT_USB";
 ...
 public void isServiceStarted(Promise promise) {
  ...
  private void requestUserPermission() {
    ...
    intent.setPackage(reactContext.getPackageName());
    int intentFlags = (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) ? PendingIntent.FLAG_MUTABLE : 0;
    PendingIntent mPendingIntent = PendingIntent.getBroadcast(reactContext, 0, intent, intentFlags);
